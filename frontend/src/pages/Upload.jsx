...
import {
  ...
  Activity, CheckCircle2, Database, Sparkles, BarChart2, HardDrive
} from 'lucide-react';
...
export default function UploadPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setStep('error');
      const msg = err?.response?.data?.detail || err?.message || 'Upload failed. Check backend connection in Settings.';
      setErrMsg(msg);
      toast.error(msg);
      return;
    }
